//获取指定的URL参数值http://localhost/pages/setmeal_detail.html?id=12&name=aa
function getUrlParam(paraName) {
    //url=http://localhost/pages/setmeal_detail.html?id=12&name=aa
    var url = document.location.toString();
    // alert(url);
    //arrObj[0]=http://localhost/pages/setmeal_detail.html
    //arrObj[1]=id=12&name=aa
...
function doLoop() {
    ...
    if (nums > 0) {
        ...
        validateCodeButton.disabled = false;//将按钮置为可以点击
